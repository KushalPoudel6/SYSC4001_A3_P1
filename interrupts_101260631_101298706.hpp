...
//function to calculate Throughput, Average Wait Time, Average Turnaround time, Average Response Time

std::string resulting_metrics(std::vector<PCB> job_list, unsigned int total_time){
    std::stringstream buffer;
